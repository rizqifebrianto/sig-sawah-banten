...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 28 Bulan Mei 2024 pada 05.18
...
INSERT INTO `wisata` (`id_sawah`, `nama_daerah`, `luas_sawah`, `deskripsi`, `latitude`, `longitude`) VALUES
...
--
ALTER TABLE `wisata`
  MODIFY `id_sawah` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
COMMIT;
