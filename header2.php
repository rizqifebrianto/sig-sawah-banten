...
<head>
	...
	<meta charset="UTF-8">
	<!-- Site Title -->
	<title>SIG PEMETAAN SAWAH BANTEN</title>

	<link rel="icon" href="admin/img/Banten.png">
...
<body>
	<header id="header">
		...
		<div class="container main-menu bg-success">
			<div class="row align-items-center justify-content-between d-flex">
				<div id="logo">
					<a href="index.php"><img src="admin/img/Banten.png" width="50px" height="50px" alt="" title="" /></a>
				</div>
